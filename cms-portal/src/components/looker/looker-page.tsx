      ...
      <div className="w-full sm:rounded-2xl rounded-t-2xl sm:max-w-md overflow-hidden animate-slide-up" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', boxShadow: '0 20px 60px rgba(0,0,0,0.12)' }}>
        ...
        <form onSubmit={handleSubmit} className="px-5 py-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input value={allowedUsers} onChange={e => setAllowedUsers(e.target.value)} placeholder="user1, user2  — or leave blank for all" className="h-9 px-3 rounded-lg text-sm outline-none" style={{ border: '1.5px solid var(--color-border)', background: 'var(--color-surface)', color: 'var(--color-text)' }} />
          </div>
